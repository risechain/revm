...
## [15.2.0](https://github.com/risechain/revm/compare/revm-interpreter-v15.1.0...revm-interpreter-v15.2.0) - 2025-11-06
...
- *(EOF)* Add non-returning CALLF/JUMPF checks ([#1663](https://github.com/risechain/revm/pull/1663))
- *(EOF)* EOF Validation add code type and sub container tracker ([#1648](https://github.com/risechain/revm/pull/1648))
- *(EOF)* implement std::error::Error trait for EofValidationError and EofError ([#1649](https://github.com/risechain/revm/pull/1649))
- *(interpreter)* derive traits on FunctionStack ([#1640](https://github.com/risechain/revm/pull/1640))
...
- support selfdestruct for dummyhost ([#1578](https://github.com/risechain/revm/pull/1578))
...
- *(EOF)* change oob behavior of RETURNDATALOAD and RETURNDATACOPY ([#1476](https://github.com/risechain/revm/pull/1476))
- *(EOF)* EIP-7698 eof creation transaction ([#1467](https://github.com/risechain/revm/pull/1467))
- adjust gas-costs for EIP-2935 BLOCKHASH ([#1422](https://github.com/risechain/revm/pull/1422))
- add Opcode::modifies_memory back ([#1421](https://github.com/risechain/revm/pull/1421))
- *(EOF)* Add CALLF/JUMPF stack checks ([#1417](https://github.com/risechain/revm/pull/1417))
- *(EOF)* remove TXCREATE ([#1415](https://github.com/risechain/revm/pull/1415))
- implement EIP-2935 ([#1354](https://github.com/risechain/revm/pull/1354))
- parse opcodes from strings ([#1358](https://github.com/risechain/revm/pull/1358))
...
- *(interpreter)* derive Eq for InterpreterAction ([#1262](https://github.com/risechain/revm/pull/1262))
...
- add tests for shift instructions ([#1254](https://github.com/risechain/revm/pull/1254))
- derive serde for OpCode, improve implementations ([#1215](https://github.com/risechain/revm/pull/1215))
- *(interpreter)* expose mutable access methods on stack and memory ([#1219](https://github.com/risechain/revm/pull/1219))
- *(interpreter)* export utility macros ([#1203](https://github.com/risechain/revm/pull/1203))
...
- *(interpreter)* OpCode struct constants ([#1173](https://github.com/risechain/revm/pull/1173))
...
- *(interpreter)* relax `make_boxed_instruction_table::FN` to `FnMut` ([#1076](https://github.com/risechain/revm/pull/1076))
- tweeks for v4.0 revm release ([#1048](https://github.com/risechain/revm/pull/1048))
- add `BytecodeLocked::original_bytecode` ([#1037](https://github.com/risechain/revm/pull/1037))
...
- add some conversions to InstructionResult ([#910](https://github.com/risechain/revm/pull/910))
- *(examples)* generate block traces ([#895](https://github.com/risechain/revm/pull/895))
- implement Default for InstructionResult ([#878](https://github.com/risechain/revm/pull/878))
...
- remove unneccesary var and if branch in gas calc ([#592](https://github.com/risechain/revm/pull/592))
- State with account status ([#499](https://github.com/risechain/revm/pull/499))
- introduce initcode size limit check taking config into account ([#587](https://github.com/risechain/revm/pull/587))
- EIP-1153 Transient storage opcodes ([#546](https://github.com/risechain/revm/pull/546))
- Rename all SHA3 opcodes to KECCAK256 ([#514](https://github.com/risechain/revm/pull/514))
- *(cancun)* EIP-5656: MCOPY - Memory copying instruction ([#528](https://github.com/risechain/revm/pull/528))
- add Memory::into_data ([#516](https://github.com/risechain/revm/pull/516))
- simplify BYTE opcode ([#512](https://github.com/risechain/revm/pull/512))
...
- use singular bytes for the jumpmap ([#402](https://github.com/risechain/revm/pull/402))
- extend SuccessOrHalt ([#405](https://github.com/risechain/revm/pull/405))
...
- Staticcall internal return ([#349](https://github.com/risechain/revm/pull/349))
...
- add DATACOPY to OpCode::modifies_memory ([#1639](https://github.com/risechain/revm/pull/1639))
- *(EOF)* returning to non-returning jumpf, enable valition error ([#1664](https://github.com/risechain/revm/pull/1664))
- *(EOF)* Validate code access in stack ([#1659](https://github.com/risechain/revm/pull/1659))
- *(eof)* deny static context in EOFCREATE ([#1644](https://github.com/risechain/revm/pull/1644))
- *(eof)* don't fail if offset overflows usize ([#1627](https://github.com/risechain/revm/pull/1627))
- *(eip7702)* Add tests and fix some bugs ([#1605](https://github.com/risechain/revm/pull/1605))
- *(EOF)* MIN_CALLEE_GAS light failure, static-mode check ([#1599](https://github.com/risechain/revm/pull/1599))
- *(eof)* ExtDelegateCall caller/target switch ([#1571](https://github.com/risechain/revm/pull/1571))
...
- *(EOF)* set CallOrCreate result in EOFCREATE ([#1535](https://github.com/risechain/revm/pull/1535))
- *(EOF)* target needed for EOFCREATE created address ([#1536](https://github.com/risechain/revm/pull/1536))
- *(EOF)* ext*call return values ([#1515](https://github.com/risechain/revm/pull/1515))
- *(EOF)* Remove redundunt ext call gas cost ([#1513](https://github.com/risechain/revm/pull/1513))
- *(EOF)* add DATACOPY copy gas ([#1510](https://github.com/risechain/revm/pull/1510))
- *(EOF)* extstaticcall make static ([#1508](https://github.com/risechain/revm/pull/1508))
- *(EOF)* jumpf gas was changes ([#1507](https://github.com/risechain/revm/pull/1507))
- *(EOF)* panic on empty input range, and continue exec after eofcreate ([#1477](https://github.com/risechain/revm/pull/1477))
- *(eof)* EOFCREATE spend gas and apply 63/64 rule ([#1471](https://github.com/risechain/revm/pull/1471))
- *(stack)* pop with five items was not correct ([#1472](https://github.com/risechain/revm/pull/1472))
- *(EOF)* returncontract immediate is one byte ([#1468](https://github.com/risechain/revm/pull/1468))
- *(Interpreter)* wrong block number used ([#1458](https://github.com/risechain/revm/pull/1458))
- *(interpreter)* avoid overflow when checking if mem limit reached ([#1429](https://github.com/risechain/revm/pull/1429))
...
- correct some stack IO ([#1302](https://github.com/risechain/revm/pull/1302))
- replace tuple in sstore return with struct ([#1115](https://github.com/risechain/revm/pull/1115))
- *(db)* Set instruction result at outcome insert ([#1117](https://github.com/risechain/revm/pull/1117))
- rename and pass optimism-default-handler to revm-primitives ([#1098](https://github.com/risechain/revm/pull/1098))
- *(Interpreter)* is_revert should call is_revert ([#1007](https://github.com/risechain/revm/pull/1007))
- cast overflow in 32-bits OS ([#978](https://github.com/risechain/revm/pull/978))
...
- *(interpreter)* Stack `push_slice` fix and dup with pointers ([#837](https://github.com/risechain/revm/pull/837))
- dont override instruction result ([#736](https://github.com/risechain/revm/pull/736))
- fix typos ([#620](https://github.com/risechain/revm/pull/620))
- fix mcopy memory expansion. Add eth tests to ci ([#586](https://github.com/risechain/revm/pull/586))
- *(interpreter)* mcopy call order ([#570](https://github.com/risechain/revm/pull/570))
- *(doc)* Inline documentation of re-exports ([#560](https://github.com/risechain/revm/pull/560))
- replace SHA3 with KECCAK256 opcode name ([#511](https://github.com/risechain/revm/pull/511))
...
- *(interpreter)* halt on CreateInitcodeSizeLimit ([#412](https://github.com/risechain/revm/pull/412))
- using pop_top instead of pop in eval_exp ([#379](https://github.com/risechain/revm/pull/379))
...
- improve `InstructionResult` documentation ([#1673](https://github.com/risechain/revm/pull/1673))
- Add EOF Layout Fuzz Loop to `revme bytecode` ([#1677](https://github.com/risechain/revm/pull/1677))
- *(eof)* Add opcodes that expand memory ([#1665](https://github.com/risechain/revm/pull/1665))
...
- *(eof)* avoid some allocations ([#1632](https://github.com/risechain/revm/pull/1632))
...
- simplify Interpreter serde ([#1544](https://github.com/risechain/revm/pull/1544))
- *(interpreter)* use U256::arithmetic_shr in SAR ([#1525](https://github.com/risechain/revm/pull/1525))
...
- *(revme)* add new line in revme EOF printer ([#1503](https://github.com/risechain/revm/pull/1503))
- remove old deprecated items ([#1489](https://github.com/risechain/revm/pull/1489))
- *(interpreter)* use max gas limit in `impl Default for Interpreter` ([#1478](https://github.com/risechain/revm/pull/1478))
- *(interpreter)* optimisation for BYTE, SHL, SHR and SAR ([#1418](https://github.com/risechain/revm/pull/1418))
...
- *(EOF)* rename extcall opcode/names ([#1416](https://github.com/risechain/revm/pull/1416))
- point to gas! in Gas::record_cost ([#1413](https://github.com/risechain/revm/pull/1413))
- pop_address should use crate scope ([#1410](https://github.com/risechain/revm/pull/1410))
- Remove Host constrain from calc_call_gas ([#1409](https://github.com/risechain/revm/pull/1409))
...
- remove unused file ([#1379](https://github.com/risechain/revm/pull/1379))
- *(interpreter)* branch less in as_usize_or_fail ([#1374](https://github.com/risechain/revm/pull/1374))
- re-use num_words in gas::cost_per_word ([#1371](https://github.com/risechain/revm/pull/1371))
- *(interpreter)* rewrite gas accounting for memory expansion ([#1361](https://github.com/risechain/revm/pull/1361))
- remove bounds check in DUP, SWAP/EXCHANGE ([#1346](https://github.com/risechain/revm/pull/1346))
- don't clone bytes in `Bytecode::bytes` ([#1344](https://github.com/risechain/revm/pull/1344))
- shrink OpCodeInfo and add more methods ([#1307](https://github.com/risechain/revm/pull/1307))
- *(interpreter)* rename some macros ([#1304](https://github.com/risechain/revm/pull/1304))
- *(interpreter)* remove EOF branch in CODE{SIZE,COPY} ([#1308](https://github.com/risechain/revm/pull/1308))
- fix some warnings ([#1305](https://github.com/risechain/revm/pull/1305))
- *(interpreter)* rename wrapping_* opcodes ([#1306](https://github.com/risechain/revm/pull/1306))
- Add the modifies_memory macro ([#1270](https://github.com/risechain/revm/pull/1270))
...
- move div by zero check from smod to i256_mod ([#1248](https://github.com/risechain/revm/pull/1248))
...
- *(interpreter)* don't run signextend with 31 too ([#1222](https://github.com/risechain/revm/pull/1222))
...
- *(interpreter)* use already-computed sign in SAR ([#1147](https://github.com/risechain/revm/pull/1147))
- *(interpreter)* factor out jump logic ([#1146](https://github.com/risechain/revm/pull/1146))
...
- adding more test for i256 ([#1090](https://github.com/risechain/revm/pull/1090))
...
- expose InstructionResult getters in Interpreter result ([#1002](https://github.com/risechain/revm/pull/1002))
...
- *(interpreter)* consistency in all_results_are_covered() ([#961](https://github.com/risechain/revm/pull/961))
- *(interpreter)* local return_error! macro ([#956](https://github.com/risechain/revm/pull/956))
- *(interpreter)* simplify the logic of calc.new_cost() ([#939](https://github.com/risechain/revm/pull/939))
- *(interpreter)* fix the name of the macro referenced by record_memory() ([#926](https://github.com/risechain/revm/pull/926))
- *(interpreter)* conditionally enable `optional_beneficiary_reward` ([#925](https://github.com/risechain/revm/pull/925))
...
- fix case for CreateInitCodeSizeLimit error ([#896](https://github.com/risechain/revm/pull/896))
- simplify use statements ([#864](https://github.com/risechain/revm/pull/864))
- *(interpreter)* use the constants from primitives ([#861](https://github.com/risechain/revm/pull/861))
- review safety comments ([#811](https://github.com/risechain/revm/pull/811))
- rewrite `Stack::push_slice` to allow arbitrary lengths ([#812](https://github.com/risechain/revm/pull/812))
- make context memory pub ([#831](https://github.com/risechain/revm/pull/831))
...
- make memory-limit private ([#796](https://github.com/risechain/revm/pull/796))
...
- *(deps)* bump proptest from 1.2.0 to 1.3.1 ([#763](https://github.com/risechain/revm/pull/763))
...
- *(interpreter)* remove dynamic dispatch from all instructions ([#739](https://github.com/risechain/revm/pull/739))
...
- accept byte slice as input ([#700](https://github.com/risechain/revm/pull/700))
- deprecate `RefDBWrapper` ([#696](https://github.com/risechain/revm/pull/696))
- *(deps)* bump proptest-derive from 0.3.0 to 0.4.0 ([#652](https://github.com/risechain/revm/pull/652))
- *(interpreter)* improve i256 instructions ([#630](https://github.com/risechain/revm/pull/630))
- *(interpreter)* improve gas calculations ([#632](https://github.com/risechain/revm/pull/632))
- *(interpreter)* use `let else` ([#629](https://github.com/risechain/revm/pull/629))
- *(interpreter)* improve dummy host ([#631](https://github.com/risechain/revm/pull/631))
...
- make calc public  ([#575](https://github.com/risechain/revm/pull/575))
...
- Add back `spec_gas_opcode` ([#446](https://github.com/risechain/revm/pull/446))
...
- Fix panic! message ([#431](https://github.com/risechain/revm/pull/431))
- *(deps)* bump arbitrary from 1.2.3 to 1.3.0 ([#428](https://github.com/risechain/revm/pull/428))
...
- add display impl for Opcode ([#406](https://github.com/risechain/revm/pull/406))
...
- *(deps)* bump proptest from 1.0.0 to 1.1.0 ([#358](https://github.com/risechain/revm/pull/358))
- revm-precompiles to revm-precompile
- set local crates versions
- nits and num of cargo keyword to 5 ([#351](https://github.com/risechain/revm/pull/351))
...
- Wrap all calls to interpreter.gas.erase_cost with checks if USE_GAS is enabled ([#346](https://github.com/risechain/revm/pull/346))
...
- enable proptest with arbitrary feature ([#323](https://github.com/risechain/revm/pull/323))
