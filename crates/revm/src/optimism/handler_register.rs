...
pub fn optimism_handle_register<'a, DB: Database, EXT>(
    ...
    Box::new(move |handler| {
        spec_to_generic!(handler.cfg.spec_id, {
            ...
            handler.post_execution.reimburse_caller = Box::new(reimburse_caller::<SPEC, EXT, DB>);
            ...
            handler.post_execution.clear = Box::new(clear::<EXT, DB>);
        });
    })
}
