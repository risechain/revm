...
## [15.2.0](https://github.com/risechain/revm/compare/revm-primitives-v15.1.0...revm-primitives-v15.2.0) - 2025-11-06
...
- EIP-7702 Add u8 validity ([#1824](https://github.com/risechain/revm/pull/1824))
...
- add helper function to mape EVMError's Database error variant ([#1567](https://github.com/risechain/revm/pull/1567))
...
- Add bytes to Bytecode ([#1396](https://github.com/risechain/revm/pull/1396))
- implement EIP-2935 ([#1354](https://github.com/risechain/revm/pull/1354))
- add `Bytecode::original_bytecode_slice` to match `BytecodeLocked` ([#1286](https://github.com/risechain/revm/pull/1286))
...
- pass rand feature to alloy_primitives ([#1276](https://github.com/risechain/revm/pull/1276))
- *(interpreter)* remove SPEC generic from gas calculation functions ([#1243](https://github.com/risechain/revm/pull/1243))
- implement Default for EnvWithHandlerCfg ([#1206](https://github.com/risechain/revm/pull/1206))
- optional nonce check ([#1195](https://github.com/risechain/revm/pull/1195))
- *(primitives)* derive Default for SpecId ([#1171](https://github.com/risechain/revm/pull/1171))
- implement DatabaseCommit for DatabaseComponents ([#1163](https://github.com/risechain/revm/pull/1163))
- add PrecompileError::Other ([#1165](https://github.com/risechain/revm/pull/1165))
...
- add is_empty_code_hash fn ([#826](https://github.com/risechain/revm/pull/826))
...
- add changed storage slots iter ([#801](https://github.com/risechain/revm/pull/801))
...
- derive PartialEq, Eq for Env ([#689](https://github.com/risechain/revm/pull/689))
...
- Implement `Error` for EVMError ([#559](https://github.com/risechain/revm/pull/559))
...
- add Output::into_data ([#420](https://github.com/risechain/revm/pull/420))
...
- add b256<->u256 from impls ([#398](https://github.com/risechain/revm/pull/398))
- add API to retrieve unpadded bytecode ([#397](https://github.com/risechain/revm/pull/397))
- *(Shanghai)* All EIPs: push0, warm coinbase, limit/measure initcode ([#376](https://github.com/risechain/revm/pull/376))
- implement Debug for DatabaseComponentError if supported ([#363](https://github.com/risechain/revm/pull/363))
...
- *(EOF)* Overflow on num_sections ([#1656](https://github.com/risechain/revm/pull/1656))
...
- missing kzg_settings if kzg-rs feature enabled ([#1601](https://github.com/risechain/revm/pull/1601))
- *(eof)* fixture 2 tests ([#1550](https://github.com/risechain/revm/pull/1550))
- *(primitives)* specify the optimism cfg on spec_to_generic ([#1412](https://github.com/risechain/revm/pull/1412))
- fix eip3155 summary gas_used bug and add fork name ([#1216](https://github.com/risechain/revm/pull/1216))
- use std hashmap with "std" feature ([#1193](https://github.com/risechain/revm/pull/1193))
...
- Set is_optimism to true if default config ([#1087](https://github.com/risechain/revm/pull/1087))
- use maximum possible data fee for 4844 balance checks ([#981](https://github.com/risechain/revm/pull/981))
- make revm-primitives no-std with c-kzg feature ([#933](https://github.com/risechain/revm/pull/933))
...
- *(primitives)* Error Primitive Display + Error Implementations ([#770](https://github.com/risechain/revm/pull/770))
- use u128 for calc_blob_gasprice ([#764](https://github.com/risechain/revm/pull/764))
- use u128 for calc data fee result ([#757](https://github.com/risechain/revm/pull/757))
- balance check disabled ([#751](https://github.com/risechain/revm/pull/751))
...
- bump newest primitives ([#1823](https://github.com/risechain/revm/pull/1823))
- release-plz update ([#1807](https://github.com/risechain/revm/pull/1807))
- release-plz update
- *(deps)* bump alloy-primitives from 0.8.0 to 0.8.2 ([#1761](https://github.com/risechain/revm/pull/1761))
...
- Renamed some city name ([#1645](https://github.com/risechain/revm/pull/1645))
...
- *(deps)* bump alloy-primitives from 0.7.6 to 0.7.7 ([#1612](https://github.com/risechain/revm/pull/1612))
- group optimism invalid txn errors ([#1604](https://github.com/risechain/revm/pull/1604))
- *(deps)* bump bitflags from 2.5.0 to 2.6.0 ([#1583](https://github.com/risechain/revm/pull/1583))
...
- add utility function AccountInfo::from_bytecode ([#1577](https://github.com/risechain/revm/pull/1577))
...
- remove DatabaseWithDebugError ([#1545](https://github.com/risechain/revm/pull/1545))
...
- derive PartialEq and Hash on EnvKzgSettings ([#1494](https://github.com/risechain/revm/pull/1494))
...
- add blob_count and max_blobs to `TooManyBlobs` err enum ([#1375](https://github.com/risechain/revm/pull/1375))
...
- Implement `with_chain_id` for `CfgEnv` ([#1327](https://github.com/risechain/revm/pull/1327))
...
- *(deps)* bump alloy 0.7.0 ([#1250](https://github.com/risechain/revm/pull/1250))
...
- *(deps)* bump bitflags from 2.4.2 to 2.5.0 ([#1210](https://github.com/risechain/revm/pull/1210))
- clarify None nonce ([#1204](https://github.com/risechain/revm/pull/1204))
...
- improve error implementations ([#1183](https://github.com/risechain/revm/pull/1183))
...
- add helper function for spec id ([#1130](https://github.com/risechain/revm/pull/1130))
...
- add some docs to StorageSlot ([#1019](https://github.com/risechain/revm/pull/1019))
- fix serde std flags for no-std build ([#987](https://github.com/risechain/revm/pull/987))
- *(deps)* bump bitflags from 2.4.1 to 2.4.2 ([#983](https://github.com/risechain/revm/pull/983))
...
- *(deps)* alloy 0.6 ([#963](https://github.com/risechain/revm/pull/963))
- *(primitives)* improve readability of Env.validate_tx() ([#924](https://github.com/risechain/revm/pull/924))
- *(primitives)* optimize AccountInfo.is_empty() ([#922](https://github.com/risechain/revm/pull/922))
...
- Add docs to `optimism` `InvalidTransaction` errors. ([#884](https://github.com/risechain/revm/pull/884))
- *(deps)* run `cargo update`, bump alloy-primitives ([#880](https://github.com/risechain/revm/pull/880))
- *(primitives)* don't duplicate the SpecId::enabled() logic ([#869](https://github.com/risechain/revm/pull/869))
- simplify use statements ([#864](https://github.com/risechain/revm/pull/864))
- cargo fmt and removed extra newlines ([#860](https://github.com/risechain/revm/pull/860))
...
- *(deps)* make derive-more optional ([#827](https://github.com/risechain/revm/pull/827))
- *(eip4844)* update kzg trusted setup ([#822](https://github.com/risechain/revm/pull/822))
- *(deps)* bump bitflags from 2.4.0 to 2.4.1 ([#803](https://github.com/risechain/revm/pull/803))
- include alloy-primitives std feature ([#788](https://github.com/risechain/revm/pull/788))
- clang requirement ([#784](https://github.com/risechain/revm/pull/784))
- *(primitives)* OptimismFields Docs Cleanup ([#778](https://github.com/risechain/revm/pull/778))
- Remove dead state trait function ([#779](https://github.com/risechain/revm/pull/779))
- Verify account is empty checks ([#780](https://github.com/risechain/revm/pull/780))
- *(primitives)* Clean up the account typs with docs ([#776](https://github.com/risechain/revm/pull/776))
- Use upstream create and create2 implementations ([#775](https://github.com/risechain/revm/pull/775))
- Implement display and error for precompile error ([#777](https://github.com/risechain/revm/pull/777))
- reorder env members ([#771](https://github.com/risechain/revm/pull/771))
...
- document when InvalidTransaction errors are thrown ([#722](https://github.com/risechain/revm/pull/722))
- rm nonexhaustive for error ([#726](https://github.com/risechain/revm/pull/726))
- clippy incorrect_clone_impl_on_copy_type ([#720](https://github.com/risechain/revm/pull/720))
...
- Small doc comment fix ([#698](https://github.com/risechain/revm/pull/698))
- deprecate `RefDBWrapper` ([#696](https://github.com/risechain/revm/pull/696))
- remove unused new_raw_with_hash ([#676](https://github.com/risechain/revm/pull/676))
...
- mark CfgEnv as non_exhaustive ([#623](https://github.com/risechain/revm/pull/623))
...
- *(deps)* bump bitflags from 2.3.3 to 2.4.0 ([#596](https://github.com/risechain/revm/pull/596))
...
- add util functions for getting output data ([#509](https://github.com/risechain/revm/pull/509))
- fix typo ([#488](https://github.com/risechain/revm/pull/488))
...
- Fix typo in primitives/src/state.rs ([#474](https://github.com/risechain/revm/pull/474))
...
- add into_logs ([#453](https://github.com/risechain/revm/pull/453))
...
- Comment Fix ([#430](https://github.com/risechain/revm/pull/430))
...
- Update readmdoc of `perf_analyse_created_bytecodes` ([#404](https://github.com/risechain/revm/pull/404))
...
- derive Debug for DatabaseComponentError ([#377](https://github.com/risechain/revm/pull/377))
- Add B160/B256 From primitive_types traits ([#380](https://github.com/risechain/revm/pull/380))
...
- use alloc & core for Arc impl ([#367](https://github.com/risechain/revm/pull/367))
- add error details to InvalidTransaction::LackOfFundForGasLimit ([#364](https://github.com/risechain/revm/pull/364))
- implement BlockHash for Arc<BlockHashRef> ([#361](https://github.com/risechain/revm/pull/361))
- implement State for Arc<StateRef> ([#360](https://github.com/risechain/revm/pull/360))
...
- expose hashbrown::HashMap in primitives ([#345](https://github.com/risechain/revm/pull/345))
- simplify DatabaseComponentError ([#339](https://github.com/risechain/revm/pull/339))
