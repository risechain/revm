...
use revm::primitives::{
    ...
    HashMap, RecoveredAuthority, RecoveredAuthorization, Signature, B256, U256,
};
...
impl TestAuthorization {
    ...
    pub fn into_recovered(self) -> RecoveredAuthorization {
        ...
        let address = self
            ...
            .ok()
            .unwrap_or_default();
        RecoveredAuthorization::new_unchecked(authorization, RecoveredAuthority::Valid(address))
    }
}
