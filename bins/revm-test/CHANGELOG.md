...
## [1.0.0](https://github.com/risechain/revm/releases/tag/revm-test-v1.0.0) - 2025-11-06
...
- *(deps)* bump bytes from 1.6.1 to 1.7.1 ([#1700](https://github.com/risechain/revm/pull/1700))
...
- *(deps)* bump regex from 1.10.5 to 1.10.6 ([#1682](https://github.com/risechain/revm/pull/1682))
...
- *(deps)* bump alloy-sol-macro from 0.7.6 to 0.7.7 ([#1613](https://github.com/risechain/revm/pull/1613))
...
- *(deps)* bump regex from 1.10.4 to 1.10.5 ([#1502](https://github.com/risechain/revm/pull/1502))
...
- revert snailtracer without microbench ([#1259](https://github.com/risechain/revm/pull/1259))
- release ([#1231](https://github.com/risechain/revm/pull/1231))
- *(deps)* bump other alloy deps 0.7.0 ([#1252](https://github.com/risechain/revm/pull/1252))
- *(deps)* bump regex from 1.10.3 to 1.10.4 ([#1223](https://github.com/risechain/revm/pull/1223))
- *(deps)* bump bytes from 1.5.0 to 1.6.0 ([#1224](https://github.com/risechain/revm/pull/1224))
...
- *(deps)* bump alloy-sol-types from 0.6.3 to 0.6.4 ([#1148](https://github.com/risechain/revm/pull/1148))
- *(deps)* bump alloy-sol-macro from 0.6.3 to 0.6.4 ([#1136](https://github.com/risechain/revm/pull/1136))
...
- *(deps)* bump alloy-sol-types from 0.6.2 to 0.6.3 ([#1103](https://github.com/risechain/revm/pull/1103))
- release ([#1082](https://github.com/risechain/revm/pull/1082))
- *(deps)* bump alloy-sol-macro from 0.6.2 to 0.6.3 ([#1094](https://github.com/risechain/revm/pull/1094))
...
- *(deps)* bump eyre from 0.6.11 to 0.6.12 ([#1051](https://github.com/risechain/revm/pull/1051))
- *(deps)* bump alloy-sol-types from 0.6.0 to 0.6.2 ([#1035](https://github.com/risechain/revm/pull/1035))
- *(deps)* bump alloy-sol-macro from 0.6.0 to 0.6.2 ([#1013](https://github.com/risechain/revm/pull/1013))
- chore(Test) : const to static ([#1016](https://github.com/risechain/revm/pull/1016))
- Burntpix criterion bench ([#1004](https://github.com/risechain/revm/pull/1004))
